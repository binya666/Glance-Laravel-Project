  ...
  <td>
    <div class="media align-items-center">
      <img
        class="me-3"
        width="87"
        src="https://uena.Binyameen.com/xhtml/page-error-404.php"
        alt="Binyameen"
      />
      <div class="media-body">
        <h5 class="mt-0 mb-2">
          <a
            class="text-black"
            href="https://uena.Binyameen.com/xhtml/page-error-404.php"
            >Sweet Cheezy Pizza for Kids Meal (Small Size)</a
          >
        </h5>
