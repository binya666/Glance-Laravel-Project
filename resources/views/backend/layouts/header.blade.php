...
<head>
    ...
    <link class="main-css" href="{{ url('backend/css/style.css') }}" rel="stylesheet">
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="backend/images/avatar/1.jpg" class="rounded-circle user_img"
                                                    alt="/">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="backend/images/avatar/2.jpg" class="rounded-circle user_img"
                                                    alt="/">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="backend/images/avatar/3.jpg" class="rounded-circle user_img"
                                                    alt="/">
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="backend/images/avatar/4.jpg" class="rounded-circle user_img"
                                                    alt="/">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dz-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="backend/images/avatar/5.jpg" class="rounded-circle user_img"
                                                    alt="/">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                            ...
                            <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                                <div class="d-flex justify-content-start mb-4">
                                    <div class="img_cont_msg">
                                        <img src="backend/images/avatar/1.jpg" class="rounded-circle user_img_msg"
                                            alt="/">
                                    </div>
                                ...
                                <div class="d-flex justify-content-end mb-4">
                                    ...
                                    <div class="img_cont_msg">
                                        <img src="backend/images/avatar/2.jpg" class="rounded-circle user_img_msg"
                                            alt="/">
                                    </div>
                                </div>
                                <div class="d-flex justify-content-start mb-4">
                        ...
                        <ul class="navbar-nav header-right">
                                                ...
                                                <div class="timeline-panel">
                                                    <div class="media me-2">
                                                        <img alt="image" width="50"
                                                            src="backend/images/avatar/1.jpg">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0);" role="button"
                                    data-bs-toggle="dropdown">
                                    <img src="backend/images/profile/pic1.jpg" width="20" alt="/">
        ...
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                        <ul aria-expanded="false" class="metismenu " id="menu">
                            <li><a href="/customer-list">Customers</a></li>
                            <li><a href="/teammember">Team Member</a></li>
                            <li><a href="/add-faqs">Add Faq</a></li>
                            <li><a href="/persona">Add Persona</a></li>
                            <li><a href="/addproduct" >Add Product</a>
                            </li>
                            <li><a href="analytics.html">Analytics</a></li>
                            <li><a href="reviews.html">Reviews</a></li>
                            <li style="padding:10px;"><a href="/admin/logout" class="" >LOGOUT</a></li>
                        </ul>


                <div class="copyright">
                    <p><strong>Uena Admin Dashboard</strong> © 2024 All Rights Reserved</p>
                    <p class="fs-12">Made with <span class="heart"></span> by Binyameen</p>
                </div>
            </div>
        </div>
