                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                ...
                                <form class="user" method="post" action="{{ url('/admin/login') }}">
                                    ...
                                    <input type="submit" name="submit" class="btn btn-user btn-block mt-4" value="Login" style="color: white; background-color: #ff720d;">

                                </form>
                                <center style="margin-top:20px;">
                                    <a class="mb-4" href="{{ url('/') }}" style="color: #ff720d;">Back to Home</a>
                                </center>
                            </div>
                        </div>
                    </div>
