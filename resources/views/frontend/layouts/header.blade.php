    ...
    <div class="page-wrapper">
            ...
            <div class="container">
                <div class="header-content">
                    ...
                    <ul class="menu-other-links">
                        ...
                        <li>
                            <a href="/account" title=""><img src="{{ asset('frontend/images/user.svg') }}" alt="" /></a>
                        </li>
                    </ul>
                    <div class="overlay-menu">
                        <ul class="menu-links">
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a style="padding: 0px 50px 0;" href="{{ url('/product/category/shoes') }}" title="">Shoes</a></li>

                                    <li><a style="padding: 0px 50px 0;" href="{{ url('/product/category/clothes') }}"
                                            title="">Clothing</a></li>
                                    <li><a style="padding: 0px 50px 0;" href="{{ url('/product/category/accessories') }}"
                                            title="">Assessories</a></li>
                                </ul>
                            <li><a style="padding: 0px 50px 0;" href="/about" title="">About</a></li>
                            </li>
                            <li>
                                <a style="padding: 0px 50px 0;" href="/blog-single" title="">blog</a>
                            </li>
                            <li>
                                <a style="padding: 0px 50px 0;" href="/contact" title="">contact us</a>
                            </li>
                            <li>
                                <a style="padding: 0px 50px 0;" href="/login" title="">Login</a>
                            </li>
                        </ul>
        ...
        <div class="cart-sidebar">
            ...
            <div class="cart-body">
                ...
                <ul class="cart-sidebar-products">
                    <li>
                        <div class="cart-product-column">
                            <div class="card-product-thumb-sd">
                                <img src="{{ asset('frontend/images/resource/cr1.jpg') }}" alt="" />
                            </div>
                    ...
                    <li>
                        <div class="cart-product-column">
                            <div class="card-product-thumb-sd">
                                <img src="{{ asset('frontend/images/resource/cr2.jpg') }}" alt="" />
                            </div>
                            <div class="card-product-thumb-info">
                                <a href="#" title="" class="close-cart-product">
                                    <svg width="11" height="11" viewBox="0 0 11 11" fill="none"
                    ...
                    <li>
                        <div class="cart-product-column">
                            <div class="card-product-thumb-sd">
                                <img src="{{ asset('frontend/images/resource/cr3.jpg') }}" alt="" />
                            </div>
                            <div class="card-product-thumb-info">
                                <a href="#" title="" class="close-cart-product">
                                    <svg width="11" height="11" viewBox="0 0 11 11" fill="none"
                    ...
                    <li>
                        <div class="cart-product-column">
                            <div class="card-product-thumb-sd">
                                <img src="{{ asset('frontend/images/resource/cr4.jpg') }}" alt="" />
                            </div>
                            <div class="card-product-thumb-info">
                                <a href="#" title="" class="close-cart-product">
                                    <svg width="11" height="11" viewBox="0 0 11 11" fill="none"
            ...
            <div class="cart-footer">
                ...
                <span>Tax included <a href="#" title="">Shipping</a> calculated at
                    checkout.</span>
                <div class="agree-terms">
                    <label class="containerr">I agree with <a href="#" title=""> Terms &amp;
                            Conditions</a>
                        <input type="checkbox" />
        ...
        <div class="search-box">
            <div class="search-box-content">
                ...
                <a href="#" title="" class="close-search"><img src="{{ asset('frontend/images/close2.png') }}"
                        alt="" /></a>
            </div>
        </div>
