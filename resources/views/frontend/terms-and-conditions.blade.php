...
<html lang="en">
  <head>
    ...
    <!-- Stylesheets -->
    <link href=href="{{ url('frontend/css/all.min.css')}}" rel="stylesheet" />
    <link href=href="{{ url('frontend/css/bootstrap.min.css')}}" rel="stylesheet" />
    <link href=href="{{ url('frontend/css/slick.css')}}" rel="stylesheet" />
    <link href=href="{{ url('frontend/css/slick-theme.css')}}" rel="stylesheet" />
    <link href=href="{{ url('frontend/css/swiper-bundle.min.css')}}" rel="stylesheet" />
    <link href=href="{{ url('frontend/css/style.css')}}" rel="stylesheet" />

    <link rel="shortcut icon" href="frontend/images/favicon.png" type="image/x-icon" />
    <link rel="icon" href=href="{{ url('frontend/images/favicon.png')}}" type="image/x-icon" />
    <link
      rel="stylesheet"
  ...
  <body>
    <div class="page-wrapper">
      ...
      <header>
            ...
            <ul class="menu-other-links">
              <li>
                <a href="#" title="" class="search-btn">
                  <img src="frontend/images/search.png" alt="" />
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="login.php" title=""
                  ><img src="frontend/images/user.svg" alt=""
                /></a>
              </li>
            </ul>
        ...
        <ul class="menu-links">
          <li >
            <a style="padding: 0px 50px 0;" href="/" title="">Home</a>
          </li>
          <li>
            <a style="padding: 0px 50px 0;" href="#" title="">Category</a>
            <ul>
              <li><a style="padding: 0px 50px 0;" href="shop-category.php" title="">Shoes</a></li>
              <li><a style="padding: 0px 50px 0;" href="shop-category.php" title="">Clothing</a></li>
              <li><a style="padding: 0px 50px 0;" href="shop-category.php" title="">Assessories</a></li>
            </ul>
            <li><a style="padding: 0px 50px 0;" href="About.php" title="">About</a></li>
          </li>
          <li>
            <a style="padding: 0px 50px 0;" href="single-article.php" title="">blog</a>
          </li>
          <li>
            <a style="padding: 0px 50px 0;" href="/contact" title="">contact us</a>
          </li>
          <li>
            <a style="padding: 0px 50px 0;" href="login.php" title="">Login</a>
          </li>
        </ul>
        <div
          class="marquee3"
      ...
      <div class="cart-sidebar">
        ...
        <div class="cart-body">
          ...
          <ul class="cart-sidebar-products">
            <li>
              <div class="cart-product-column">
                <div class="card-product-thumb-sd">
                  <img src="frontend/images/resource/cr1.jpg" alt="" />
                </div>
            ...
            <li>
              <div class="cart-product-column">
                <div class="card-product-thumb-sd">
                  <img src="frontend/images/resource/cr2.jpg" alt="" />
                </div>
                <div class="card-product-thumb-info">
                  <a href="#" title="" class="close-cart-product">
                    <svg
            ...
            <li>
              <div class="cart-product-column">
                <div class="card-product-thumb-sd">
                  <img src="frontend/images/resource/cr3.jpg" alt="" />
                </div>
                <div class="card-product-thumb-info">
                  <a href="#" title="" class="close-cart-product">
                    <svg
            ...
            <li>
              <div class="cart-product-column">
                <div class="card-product-thumb-sd">
                  <img src="frontend/images/resource/cr4.jpg" alt="" />
                </div>
                <div class="card-product-thumb-info">
                  <a href="#" title="" class="close-cart-product">
                    <svg
        ...
        <div class="cart-footer">
          ...
          <img src="frontend/images/progress.png" alt="" />
      ...
      <section class="terms-banner">
        <div class="container">
          <div class="terms-content">
            <div class="terms-img">
              <img src="frontend/images/resource/terms.png" alt="" />
            </div>
            ...
            <p>
              ...
              rutrum. Curabitur molestie nec mi in congue. Nam luctus ante quis
              urna molestie.
            </p>
          </div>
          <!--terms-content-->
        ...
        <div class="container-fluid">
          <div class="row">
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term1.png" alt="" />
                </div>
                ...
                <a href="#" title="" class="theme-btn">read more</a>
              </div>
              <!--terms-col-->
            </div>
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term2.png" alt="" />
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term3.png" alt="" />
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term4.png" alt="" />
                </div>
                <h3>Platform for Transaction</h3>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
                  luctus leo sit amet lorem egestas iaculis. Donec nibh enim,
                  pharetra vel turpis non, vulputate luctus ex.
            ...
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term5.png" alt="" />
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term6.png" alt="" />
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term7.png" alt="" />
                </div>
                <h3>glance Replacement</h3>
                <p>
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. In
                  luctus leo sit amet lorem egestas iaculis. Donec nibh enim,
                  pharetra vel turpis non, vulputate luctus ex.
            ...
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term8.png" alt="" />
                </div>
            ...
            <div class="col-lg-4 col-md-6">
              <div class="terms-col">
                <div class="term-icon">
                  <img src="frontend/images/term9.png" alt="" />
                </div>
        ...
        <div class="container">
          <div class="lookboo-glance wow slideInUp">
            <div class="lookbook-slider">
              <div class="lookbook">
                <img src="frontend/images/resource/lookbook5.jpg" alt="" />
              </div>
              <!--lookbook-->
              <div class="lookbook">
                <img src="frontend/images/resource/lookbook2.jpg" alt="" />
              </div>
              <!--lookbook-->
              <div class="lookbook">
                <img src="frontend/images/resource/lookbook3.jpg" alt="" />
              </div>
              <!--lookbook-->
              <div class="lookbook">
                <img src="frontend/images/resource/lookbook4.jpg" alt="" />
              </div>
              <!--lookbook-->
            </div>
            <h1 class="pb-text wow fadeInUp">lookbook</h1>
          </div>
        </div>
      </section>
